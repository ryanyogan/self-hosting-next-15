...
SECRET_KEY="super-secret" # for the demo app
NEXT_PUBLIC_SAFE_KEY="super-safe-key" # for the demo app
DOMAIN_NAME="echlon.io" # replace with your DNS domain
EMAIL="ryanyogan@gmail.com" # replace with your email

# Script Vars
REPO_URL="https://github.com/ryanyogan/self-hosting-next-15.git"
APP_DIR=~/myapp
...
# Make swap permanent (this may not be needed, I am cheap, using 512mb ram droplet)
...
# Note: This would be if you are using Vercel PG, in the end DATABASE_URL is all that matters
# for most connections.  The URL_EXTERNAL is for external tools that need to connect to the DB
...
# This shows how you can expose an env var, kill this off
# TODO: Remove this @ryan
